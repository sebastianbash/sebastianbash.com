...
export default function Services() {
  return (
    <div id="services" className="services-section">
      <div className="services-wrapper w-full mb-20 h-[90rem] lg:h-[40rem] relative flex flex-col justify-evenly md:justify-center items-center">
        <div className="service-title">
          <h2 className="text-[2.5rem] leading-[2.75rem] tracking-[-2.5px] text-center text-[##0D0E10] font-[600]">
            Servicios
          </h2>
        </div>
        <div className="services-cards w-full h-5/6 md:h-4/5 lg:h-3/4 flex flex-col justify-around items-center lg:flex-row md:justify-evenly lg:justify-between md:items-center">
          <div className="service-card hover:shadow-xl transition-all w-4/5 md:w-3/5 lg:w-[20.8rem] h-[20rem] md:h-[22rem] lg:h-[22rem] bg-white py-12 px-8 flex flex-col justify-around space-y-8">
            ...
            <h4 className="text-2xl tracking-[-.6px] font-[600] text-[#0D0E10]">Strategy & Direction</h4>
            <p>
