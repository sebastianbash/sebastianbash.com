...
export default function Clients() {
  return (
    <div className="cli-section h-[500px] md:h-[28rem] w-full flex flex-col justify-center items-center">
        <div className="cli-wrapper h-full md:h-[11rem] flex flex-col justify-evenly md:justify-between items-center">
            ...
            <div className="cli-brands flex flex-col md:flex-row justify-center items-center md:space-x-16">
                <div className="logo-card px-8 py-6 opacity-50 hover:opacity-100 bg-white md:hover:shadow-xl transition-all">
